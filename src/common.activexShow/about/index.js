define(function(require,exports,module){
    ...
    require("common.activexShow/about/index.css");
    //页面逻辑
    var app = {
        ...
        img_show: function(v){
            ...
            var aboutTpl = require("common.activexShow/about/index.tpl");
            ...
            $.each(v.attrList, function(i,j){
                if(j.tagId == "model_name"){
                    ...
                    var aboutTpl = require("common.activexShow/about/pics.tpl");
