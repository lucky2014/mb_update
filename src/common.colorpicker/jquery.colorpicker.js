    ...
    (function($) {
        ...
        $.fn.colorpicker = function(options) {
            ...
            function initColor(){
                ...
                colorTable='<table width=255 border="0" cellspacing="0" cellpadding="0" style="border:2px solid #33a7c0;border-bottom:none;">'
                +'<tr height=30><td colspan=21 bgcolor=#fff>'
                +'<table cellpadding="0" cellspacing="1" border="0" style="border-collapse: collapse">'
                +'<tr><td width="3"><td><input type="text" id="DisColor" size="6" disabled style="border:solid 1px #dcdcf5;background-color:#ffff00"></td>'
                +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:1px solid #dcdcf5;height:19px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a></td></tr></table></td></table>'
                ...
                $("#CT tbody tr td:first-child").css("border-left","2px solid #33a7c0");
                $("#CT tbody tr td:last-child").css("border-right","2px solid #33a7c0");
                $("#CT tbody tr:last-child td").css("border-bottom","2px solid #33a7c0");
            }
