define(function(require,exports,module){
    ...
    require("preview/src/common.hotCategory/index.css");
    ...
    var app = {
        ...
        img_show: function(v){
            ...
            var productTpl = require("preview/src/common.hotCategory/index.tpl");
            ...
            $.each(v.attrList, function(i,j){
                if(j.tagId == "model_name_prduct_2"){
                    ...
                    $(".hotCategory .recoTitle").css("background-image", "url("+j.value.value+")");
                     ...
                     var picsTpl = require("preview/src/common.hotCategory/pics.tpl");
