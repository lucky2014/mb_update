define(function(require,exports,module){
    ...
    require("preview/src/common.newProduct/index.css");
    ...
    var app = {
        ...
        img_show: function(v){
            ...
            var productTpl = require("preview/src/common.newProduct/index.tpl");
            ...
            $.each(v.attrList, function(i,j){
                if(j.tagName == "input"){
                    ...
                    j.text = 1; //用以区分
                     ...
                     var picsTpl = require("preview/src/common.newProduct/pics.tpl");
