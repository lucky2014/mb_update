                  ...
                  <div id="groupSkin" class="groupSkin-content" style="width:340px;">
                      <div id="button_text" class="colorSelectorWrapper clearfix none" style="display: block;">
                          ...
                          <div class="clearfix btnText" style="float:left;margin-bottom:20px;">
                              <input type="text" name="" value="渐变按钮" class="form-control">
                          </div>
                      </div>
                      <div class="linkDemo">
                          <!-- <div class="linkDemo"> -->
                      ...
                      <div id="background_color" class="colorSelectorWrapper none" style="height: 34px; display: block;">
                        ...
                        <div class="c-colorWrapper n-c-colorWrapper selectCommon" style="float: left;">
                            ...
                            <input type="text" theColor="rgb(121, 205, 255)" readonly class="skin-colorSelector skin-colorSelector-bgTp" data-color="rgb(121, 205, 255)">
                        ...
                        <div class="c-colorWrapper n-c-colorWrapper selectCommon" style="float: left;">
                            <!-- <div class="c-opacityBg"></div>
                            <div class="fieldSkin-color colorConfig" style="background-color: rgba(0,0,0,0);" config="#687683" status="v_paragraph_style1_border_color"></div> -->
                            <input type="text" theColor="rgb(29, 155, 227)" readonly class="skin-colorSelector skin-colorSelector-bgBtm" data-color="rgb(29, 155, 227)">
