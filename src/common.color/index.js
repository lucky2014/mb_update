    ...
    　　　　        var docFragment = rangeObj.cloneContents();
            ...
            　　　　colorText = testDiv.innerHTML;
                ...
                onHide: function (colpkr) {
                    ...
                    colorText = "";
                    colorText2 = "";
                    $(me.dragTarget).children().find(".changeColor").removeClass("changeColor")
                    return false;
                },
                onChange: function (hsb, hex, rgb) {
                    ...
                    if(currEle==".skin-colorSelector-border"){
                        if($(me.dragTarget).find("svg")[0]){
                            ...
                            $(me.dragTarget).children().css("border-color",'#' + hex);
                        }
                    }else if(currEle==".skin-colorSelector-bg"){
                        if($(me.dragTarget).find("svg")[0]){
                            $(me.dragTarget).find("svg").children().css("fill",'#' + hex);
                        }else{
                            $(me.dragTarget).children().css("backgroundColor",'#' + hex)
                        }
